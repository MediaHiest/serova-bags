...
export default async function OrderSuccessPage({ searchParams }: OrderSuccessProps) {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-20 text-center">
      <div className="mb-6">
        <div className="w-16 h-16 rounded-full bg-green-charcoal/10 flex items-center justify-center mx-auto mb-6">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-green-charcoal">
            <path d="M5 13l4 4L19 7" />
          </svg>
        </div>
        <h1 className="page-title text-3xl text-text-dark mb-4">Order Confirmed!</h1>
        <p className="text-text-muted font-normal mb-2">
